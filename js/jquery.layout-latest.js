...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	,	spacing_open:			2		// space between pane and adjacent panes - when pane is 'open'
	,	spacing_closed:			6			// ditto - when pane is 'closed'
	,	togglerLength_open:		60			// Length = WIDTH of toggler button on north/south sides - HEIGHT on east/west sides
